...
public class LineChartDemo extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.line_chart_demo);
...
//        leftYAxis.setZeroLineWidth(1f);
    ...
    void initLine() {
        ...
        createLine(mList1, mEntries1, mLineDataSet1, Color.BLUE, mLineData, mLineChart);
        createLine(mList2, mEntries2, mLineDataSet2, Color.BLACK, mLineData, mLineChart);
        createLine(mList3, mEntries3, mLineDataSet3, Color.RED, mLineData, mLineChart);
